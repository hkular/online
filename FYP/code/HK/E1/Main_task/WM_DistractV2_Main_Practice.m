...
%%  adapted by HK, Sept 2021, for FYP exp 1 does noise boost precision
%
...
%try
    ...
    % what are Rosanne's general use scripts??
    %GeneralUseScripts = '/Users/roseanne/Dropbox/GeneralUseScripts';
    ...
    Screen('Preference', 'SkipSyncTests', 1); % added this to try to make display not quit
    Screens = Screen('Screens'); %look at available screens
    ScreenNr = Screens(1); % changed from screen 1 to 2 , pick screen with largest screen number
    ...
    % HideCursor; commented out for debugging issues
