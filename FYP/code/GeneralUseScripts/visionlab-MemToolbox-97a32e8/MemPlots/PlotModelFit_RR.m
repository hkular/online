% PLOTMODELFIT_RR plots the probability density function of the model 
...
function figHand = PlotModelFit_RR(model, params, data, varargin)
...
%   bar(x, normed_n, 'EdgeColor', [1 1 1], 'FaceColor', [.8 .8 .8]);
  ...
  hold on;
  set(gca, 'XTick',[-180 -90 0 90 180],'YTick',[0 .01 .02 .03 .04 .05],'LineWidth',2,'Box','off','YGrid','on','Ylim',[0 .05],'Xlim',[-180 180]);
