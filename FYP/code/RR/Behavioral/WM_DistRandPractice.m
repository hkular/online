...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                   WM_DistRand - PRACTICE SCRIPT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 10 trials just to practice the mouse response
...
try
    ...
    cd(datadir_local);
    if exist(['DataDistRandPractice_', p.SubNum, '.mat']);
        load(['DataDistRandPractice_', p.SubNum, '.mat']);
    ...
    Screen(window,'TextFont','Helvetica');
    ByebyeText = 'Great work! You have finished this practice run';
    ...
    cd(datadir_local);
    eval(['save DataDistRandPractice_', p.SubNum, '.mat TheData'])
    %save to server too
