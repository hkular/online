...
function Additional_singleton_task_1block_popout_1color(p,win,r)
%--------------------------------------------------------------------------
...
prefs.targetColor = p.blockColor(r);
...
%         rotation = randi([round(-degreeStep/2),round(degreeStep/2)],1,1);
        ...
        if p.blockColor(r) == 1 % target color is green
            tCol = prefs.green;
            dCol = prefs.red;
        else
            tCol = prefs.red;
        ...
        data.block_color(1,b) = p.blockColor(r);
